                                    ...
                                    <div class="table-responsive">
                                        <table id="manage_org" class="table table-striped table-bordered zero-configuration">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $sql = "SELECT et.*, eq.* FROM exam_title et
                                                INNER JOIN exam_question eq ON et.id = eq.exam_id
                                                GROUP BY et.id";
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {  
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="test_page.php?org_id=<?php echo $row['exam_id']; ?>" title="Edit" class="mr-1 bg-dark btn text-white"><i class="fa fa-pencil" aria-hidden="true"></i> Take Test</a>
