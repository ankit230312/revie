...
$sql = "SELECT * FROM designation where org_id = '". $get_id ."'";

$result = mysqli_query($conn, $sql);
$row11 = mysqli_fetch_assoc($result);

// print_r($row['designation']);
// die();
...
if (isset($_POST['update_desig'])) {
    ...
    SET `org_id`='$org_id',
    `role_id`='$role_id',
    `designation`='$degis_title',
    `slug`='$slug' WHERE org_id= $get_id";
    if (mysqli_query($conn, $sql)) {
        echo "<script>alert('New Designation Update')</script>";
        echo "<script>window.location.replace('manage_designation.php');</script>";
    } else {
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">Update Designation</h4>
                                    ...
                                    <form class="form" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="degis_title" class="form-control" value="<?php echo $row11['designation']; ?>" placeholder="Designation Title" name="degis_title">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="btn btn-primary" name="update_desig">
