...
if (isset($_POST['class_save'])) {
    ...
    $sql = "INSERT INTO `class`(`org_id`, `class`,`slug`) VALUES ('$org_id','$class_title','$slug')";

    if (mysqli_query($conn, $sql)) {
        echo "<script>alert('New Class Created')</script>";
        echo "<script>window.location.replace('create_class.php');</script>";
    } else {
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">Create Class</h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="class_title" class="form-control" placeholder="Class Title" name="class_title">
                                                    </div>
                                                </div>
