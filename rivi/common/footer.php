    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>AG Road near teerth town Opp.Stanza living, Baner-411021</p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+91 8208468714</p>
...
<script>
    window.addEventListener('DOMContentLoaded', (event) => {
        ...
        if (currentUrl === "https://rivietechnology.com/test/") {

            currentUrl = "https://rivietechnology.com/test/index.php";
