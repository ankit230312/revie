  ...
  <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="index.html"><i data-feather="users" class="feather icon-users"></i><span class="menu-title" data-i18n="Dashboard">Staff Management</span><span class="badge badge badge-primary badge-pill float-right mr-2"></span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="general_setting.php" data-i18n="eCommerce">Create Designation</a>
            </li>
            <li><a class="menu-item" href="create_org.php" data-i18n="eCommerce">Set Permission</a>
            </li>


          </ul>
        </li>
        <li class=" nav-item"><a href="index.html"><i data-feather="users" class="feather icon-users"></i><span class="menu-title" data-i18n="Dashboard">Fees Management</span><span class="badge badge badge-primary badge-pill float-right mr-2"></span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="general_setting.php" data-i18n="eCommerce">Create fees</a>
            </li>
            <li><a class="menu-item" href="create_org.php" data-i18n="eCommerce">Submit Fees</a>
            </li>
            <li><a class="menu-item" href="create_org.php" data-i18n="eCommerce">Pending Fees</a>
            </li>


          </ul>
        </li>
        <li class=" nav-item"><a href="index.html"><i data-feather="users" class="feather icon-users"></i><span class="menu-title" data-i18n="Dashboard">Quiz Setup</span><span class="badge badge badge-primary badge-pill float-right mr-2"></span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="general_setting.php" data-i18n="eCommerce">Create Question</a>
            </li>
            <li><a class="menu-item" href="create_org.php" data-i18n="eCommerce">Create Batches</a>
            </li>

            <li><a class="menu-item" href="create_org.php" data-i18n="eCommerce">Manage Marks</a>
            </li>

          </ul>
        </li>
        <li class=" nav-item"><a href="index.html"><i data-feather="users" class="feather icon-users"></i><span class="menu-title" data-i18n="Dashboard">Test Management</span><span class="badge badge badge-primary badge-pill float-right mr-2"></span></a>
          <ul class="menu-content">
        ...
        <li class=" nav-item"><a href="index.html"><i data-feather="users" class="feather icon-users"></i><span class="menu-title" data-i18n="Dashboard">Practice Test</span><span class="badge badge badge-primary badge-pill float-right mr-2"></span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="general_setting.php" data-i18n="eCommerce">Create Test</a>
            </li>
            <li><a class="menu-item" href="create_org.php" data-i18n="eCommerce">Assign Test</a>
        ...
        <li class=" nav-item"><a href="index.html"><i data-feather="users" class="feather icon-users"></i><span class="menu-title" data-i18n="Dashboard">Analysis</span><span class="badge badge badge-primary badge-pill float-right mr-2"></span></a>
          <ul class="menu-content">
        ...
        <li class=" nav-item"><a href="index.html"><i data-feather="users" class="feather icon-users"></i><span class="menu-title" data-i18n="Dashboard">Notifications</span><span class="badge badge badge-primary badge-pill float-right mr-2"></span></a>
          <ul class="menu-content">
        ...
        <li class=" nav-item"><a href="index.html"><i data-feather="users" class="feather icon-users"></i><span class="menu-title" data-i18n="Dashboard">Document Sharing</span><span class="badge badge badge-primary badge-pill float-right mr-2"></span></a>
          <ul class="menu-content">
