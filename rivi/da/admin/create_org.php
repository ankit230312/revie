...
$sql = "INSERT INTO `organisation`(`org_code`, `org_name`, `org_contact`, `org_email`, `org_add`, `org_abt`, `user_admin_id`) 
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">Create Orgainisation</h4>
                                    ...
                                    <form class="form" method="POST" action="" >
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="projectinput1" class="form-control" placeholder="First Name" name="org_code">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="projectinput2">Organisation Name</label>
                                                        <input type="text" id="projectinput2" class="form-control" placeholder="Last Name" name="org_name">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="projectinput2">Registration Date</label>
                                                        <input type="date" id="projectinput2" class="form-control" placeholder="Registration Date" name="org_reg_date">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="projectinput3" class="form-control" placeholder="E-mail" name="org_email">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput4">Contact Number</label>
                                                        <input type="text" id="projectinput4" class="form-control" placeholder="Phone" name="org_contact">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="companyName" class="form-control" placeholder="Company Name" name="org_add">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="projectinput8" rows="5" class="form-control"  placeholder="About Organisation" name="org_abt"></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="btn btn-primary" name= "org_sub">
