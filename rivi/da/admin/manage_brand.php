                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['brd_email']; ?></td>
                                                        <td><?php echo $row['brd_con']; ?></td>                                                      
                                                        <td><?php echo $row['brd_add']; ?></td>
                                                        <td><?php echo $row['brd_dis']; ?></td>
                                                        <td><?php echo $row['brd_regis']; ?></td>
                                                        <td>
