...
$sql = "INSERT INTO `user_info`(`f_name`, `l_name`, `user_regis`, `email`, `contact`, `address`) 
VALUES ('$u_fname','$u_lname','$u_regis','$u_email','$u_phone','$u_regis')";
                                    ...
                                    <form class="form" method="POST">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="projectinput2" class="form-control" placeholder="Last Name" name="u_lname">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="projectinput2">Registration Date</label>
                                                        <input type="date" id="projectinput2" class="form-control" placeholder="Registration Date" name="u_regis">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="projectinput3" class="form-control" placeholder="E-mail" name="u_email">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput4">Contact Number</label>
                                                        <input type="text" id="projectinput4" class="form-control" placeholder="Phone" name="u_phone">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="companyName" class="form-control" placeholder="Company Name" name="u_add">
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="btn btn-primary" name="user_save">
