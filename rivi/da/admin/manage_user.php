                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row['user_regis']; ?></td>

                                                            <td>
                                                                <a href="update_user.php?org_id=<?php echo $row['id']; ?>" title="Edit" class="mr-1"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                                <a href="delete_user.php?org_id=<?php echo $row['id']; ?>" title="Delete" class=""><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                            </td>
